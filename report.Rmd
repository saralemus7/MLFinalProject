...
$$ \textbf{Body Parts Pre Score - Post Score} = 16.43 \ + \ 2.45 \ (\text{site = 3}) \ + \ 2.97 \ (\text{site = 4}) \ + \ 3.30 \ (\text{site= 5}) $$
$$ \textbf{Letters Pre Score - Post Score} = 10.52 \ + \ 3.09 \ (\text{site = 2}) \ - \ 2.86 \ (\text{site = 3}) \ + 4.85 \ (\text{ViewCat = 3 to 5 Times Per Week}) +$$
$$ 4.77 \ (\text{ViewCat = 5 Times a Week or More on Avg}) $$
$$ \textbf{Forms Pre Score - Post Score} = 16.04 \ + \ 2.48 \ (\text{ViewCat = 5 Times a Week or More on Avg})$$
$$ \textbf{Numbers Pre Score - Post Score} = 15.39 \ + \ 2.56 \ (\text{site = 2}) \ + \ 3.20 \ (\text{ViewCat = 3 to 5 Times Per Week}) + $$
$$ 3.64 \ (\text{ViewCat = 5 Times a Week or More on Avg})$$
$$ \textbf{Relational Terms Pre Score - Post Score} = 18.49 \ + \ 2.42 \ (\text{site = 4}) \ + \ 2.96 \ (\text{ViewCat = 5 Times a Week or More on Avg}) $$
$$ \textbf{Classification Skills Pre Score - Post Score} = 10.95 \ + \ 4.06 \ (\text{ViewCat = 5 Times a Week or More on Avg}) $$
