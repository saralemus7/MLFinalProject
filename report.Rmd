...
$$ Pretest-Posttest = \beta_0 \ + \ \beta_1 \ (\text{site = 2})+ \ \beta_2\ (\text{site = 3})+ \ \beta_3 \ (\text{site = 4})+ \ \beta_5 \ (\text{site = 5}) + \ \beta_6 \ (\text{sex =female}) \\$$ 
$$+ \ \beta_7 \ (age) \ 
