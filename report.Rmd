...
kernels that can place complex decision boundaries. We also implemented a classification tree and a logistic model to answer this question as well (See Appendix for more details). However, we decide to present the SVM model as our final model choice because the three have relatively similar performance in terms of overall prediction accuracy and we have spent a considerable amount of time researching different optimization methods to boost its performance, which is one of the big takeaways we have acquired from this project. Our full model formula is:
...
## Research Question 2: Extra SVM models
