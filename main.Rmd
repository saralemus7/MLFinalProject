...
We are looking into dimensionality reduction techniques, more specifically principal component analysis (PCA). By reducing the dimension of our feature space, there will be fewer relationships between variables to consider and we will be less likely to overfit our model. 

```{r PCA}

set.seed(3241)

sesame.sd.covariates <- sesame.sd[, c("female", "male", "sd_age", "sd_pBod", "sd_plet", "sd_pform", "sd_pnumb", "sd_prelat", "sd_pclasf", "sd_peabody")]

pr.out <- prcomp(sesame.sd.covariates, scale = TRUE)
...
predict(boost.tree, newdata=test.2)
```
