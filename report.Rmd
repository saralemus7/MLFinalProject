...
We address our research questions using various machine modeling techniques. More specifically, we will use ____ an SVMS to classify the background that the child is from.
