...
* We see that if a child is in site 1 and 2 (3-5 year old disadvantage child from the innter city, 4 year old advantage child from the suburbs respectively)
...
Regression Tree 2  
For difference in letter recognition scores:  

* If the child is in site 1, 3, 4, 5 ( 3-5 year old disadvantaged child from the inner city,  an advantaged rural child,  a disadvantaged rural child. ,a value of 5 represents a disadvantaged Spanish speaking child)
...
Regression Tree 3  
For difference in form recognition scores:  

* If the child rarely watches Sesame Street (viewcat: 1)
...
Regression Tree 4  
For difference in numbers testing scores:  
...
Overall, this tree shows that for children who watch Sesame Street frequently, the improvement in numbers testing is greater than some of the children who watch Sesame Street less frequently, depending on the child’s background. 

Regression Tree 5
For difference in relation terms scores:  
...
Regression Tree 6  
For difference in classification skills scores:  
